 ...
 */
public class ListaGiocatoriPartitaConfermataAT extends AsyncTask<Void, Void, ListaGiocatoriBean>
{
    Context context;
    ...
    public ListaGiocatoriPartitaConfermataAT(Context context, ListaGiocatoriPartitaTC taskCallback, Long idPartita, Long idSessione, Activity activity) {
    ...
    protected ListaGiocatoriBean doInBackground(Void... unused) {
        ...
        try {
            PdE2015.Api.ListaGiocatoriPartitaConfermata get = apiHandler.api().listaGiocatoriPartitaConfermata(idPartita, idSessione);
            ...
            taskCallback.done(false, null, null, "ListaGiocatoriPartitaConfermata", "CONFERMATA");
        }
    ...
    protected void onPostExecute(ListaGiocatoriBean response) {
        if(response != null)
            taskCallback.done(true, response.getListaGiocatori(), response.getListaAmici(), "ListaGiocatoriPartitaConfermata", "CONFERMATA");
        else {
