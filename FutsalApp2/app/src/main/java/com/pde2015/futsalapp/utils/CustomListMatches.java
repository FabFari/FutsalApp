...
public class CustomListMatches extends ArrayAdapter<PartitaBean> {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        TextView statoView = (TextView)rowView.findViewById(R.id.match_view_stato);
        ...
        nomeChiProponeView.setText("Proposta da: "+matches.get(position).getPartita().getPropone());
        dataView.setText(matches.get(position).getDataString());
        quotaView.setText("Quota: "+matches.get(position).getPartita().getQuota().toString());
        statoView.setText("Stato: "+matches.get(position).getPartita().getStatoCorrente());
