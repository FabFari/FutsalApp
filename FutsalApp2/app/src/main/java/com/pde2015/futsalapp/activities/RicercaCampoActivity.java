...
public class RicercaCampoActivity extends AppCompatActivity implements ListaStatiTC, AggiornaStatoTC, SessioneIndietroTC, ListaCampiTC, View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameCapture.setHint("Digita il nome del campo da cercare");
    ...
    public void done(boolean res)
    {
        if( res ) {
            ...
            if( statoSuccessivo.equals(AppConstants.CREA_CAMPO)) {
                Intent i = new Intent(RicercaCampoActivity.this, CreaCampoActivity.class);
            ...
            else if( statoSuccessivo.equals(AppConstants.CAMPO)) {
                Intent i = new Intent(RicercaCampoActivity.this, CampoActivity.class);
                i.putExtra("idGruppo", idGruppo);
                i.putExtra("idSessione", idSessione);
                i.putExtra("idPartita", idPartita);
                i.putExtra("email", emailUtente);
                i.putExtra("idCampo", selectedCampo);
                startActivity(i);
                this.finish();
            }
        }
