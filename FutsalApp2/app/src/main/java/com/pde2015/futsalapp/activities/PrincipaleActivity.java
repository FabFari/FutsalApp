...
public class PrincipaleActivity extends AppCompatActivity implements ListaStatiTC, AggiornaStatoTC,
        ListaGruppiIscrittoTC, View.OnClickListener, GetGiocatoreTC {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Prendo le info del giocatore
        if(checkNetwork()) new GetGiocatoreAT(getApplicationContext(), this, this, idSessione, emailUtente).execute();
    ...
    public void done(boolean res, GiocatoreBean response) {
        if(res && response.getHttpCode().equals(AppConstants.OK)) {
            TextView welcomeText = (TextView)findViewById(R.id.welcome_string);
            welcomeText.setText("Benvenuto, "+response.getGiocatore().getNome());
        }
    }
