 ...
 */
public class ModificaDisponibilitaAT extends AsyncTask<Void, Void, DefaultBean> {
    Context context;
    ...
    public ModificaDisponibilitaAT(Context context, DisponibileTC taskCallback, DisponibileActivity activity, Long idSessione, InfoGestionePartiteBean payload) {
    ...
    protected DefaultBean doInBackground(Void... unused){
        ...
        try {
            ...
            PdE2015.Api.ModificaDisponibile put = apiHandler.api().modificaDisponibile(idSessione, payload);
